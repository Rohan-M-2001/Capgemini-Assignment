...
public class Assignment8 implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		user.setPassword(this.bCryptPasswordEncoder.encode("romi"));
		user.setEmail("mitrarohan2001@gmail.com");
		...
		user2.setPassword(this.bCryptPasswordEncoder.encode("Abkar"));
		user2.setEmail("shekkar69@gmail.com");
