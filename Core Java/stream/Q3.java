...
public class Q3{
	public static void main(String[] args) {
		...
		Trader t1 = new Trader("Rohan", "Delhi");
		Trader t2 = new Trader("Khushal","Bangalore");
		Trader t3 = new Trader("Sattwik","Noida");
		Trader t4 = new Trader("Vivek","Pune");
		Trader t5 = new Trader("Satyam","Indore");
