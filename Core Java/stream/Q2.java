...
class News{
	...
	public class Q2{
		public static void main(String[] args) {
			News o1 = new News(1,"Rohan","Nehil","Good");
			News o2 = new News(2,"Khushal","Abhishek","Good");
			News o3 = new News(3,"Sattwik","Khushal","Budget");
			News o4 = new News(4,"Vivek","Rishabh","Good");
			News o5 = new News(5,"Satyam","Dibbo","Budget");
